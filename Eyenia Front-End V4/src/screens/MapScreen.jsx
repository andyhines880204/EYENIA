  ...
  const  [show,setShow]=React.useState(true)
    return(
        <SafeAreaView style={{flex:1,backgroundColor:'#FFFF', marginTop:25}}>
          ...
          <Image source={require('../../assets/map_pic.png')} style={[styles.img1,{height:180,marginTop:5}]}/>
          <MapView 
          initialRegion={{
            latitude:30.733315,
            longitude:76.779419,
            ...
            onDragEnd={(e)=>{Alert.alert(JSON.stringify(e.nativeEvent.coordinate))}} title='testmarker' description='THis is desp'>
              ...
              <Image source={require('../../assets/car.png')} style={{position:'absolute', left:140, top:300, width:58.17, height:29.45}}/>
          ...
          <TouchableOpacity style={[styles.optionview,{top:hp('30%')}]} onPress={()=>{navigation.navigate('MapScreen2')}}>
          <Image source={require('../../assets/map1.png')}/>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.optionview,{top:hp('37%')}]} onPress={()=>{navigation.navigate('MapScreen3')}}>
          <IconComponentProvider IconComponent={MaterialCommunityIcons}>
              <Icon name="map-marker-account-outline" size={30} color="#000000" />
              </IconComponentProvider>
          
          </TouchableOpacity>
          <TouchableOpacity style={[styles.optionview,{top:hp('44%')}]}>
